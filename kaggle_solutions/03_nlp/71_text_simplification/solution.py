...
def main():
    ...
    # 創建解決方案實例
    solver = TextSimplification(random_state=42)
    
    # 示例用法
    print("\n使用示例:")
    print("1. 基本用法:")
    print(f"   solver = TextSimplification()")
