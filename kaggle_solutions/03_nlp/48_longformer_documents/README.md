...
```python
from solution import Longformer長文檔Solution

# 創建解決方案實例
solution = Longformer長文檔Solution()
...
**類別**: 自然語言處理
**難度**: ⭐⭐⭐
**標籤**: `03_nlp` `machine-learning` `data-science`
