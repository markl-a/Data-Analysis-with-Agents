...
```python
from solution import Thompson採樣推薦Solution

# 創建解決方案實例
solution = Thompson採樣推薦Solution()
...
**類別**: 推薦系統
**難度**: ⭐⭐⭐⭐
**標籤**: `04_recommendation` `machine-learning` `data-science` `advanced`
