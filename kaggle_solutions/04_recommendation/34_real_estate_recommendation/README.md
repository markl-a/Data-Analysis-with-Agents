...
```python
from kaggle_solutions.04_recommendation.34_real_estate_recommendation.solution import RealEstateRecommendationSolution

# 創建解決方案實例
solution = RealEstateRecommendationSolution()
