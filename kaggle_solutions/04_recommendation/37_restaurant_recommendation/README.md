...
```python
from kaggle_solutions.04_recommendation.37_restaurant_recommendation.solution import RestaurantRecommendationSolution

# 創建解決方案實例
solution = RestaurantRecommendationSolution()
