...
```python
from kaggle_solutions.16_optimization.39_reinforcement_learning_opt.solution import ReinforcementLearningOptSolution

# 創建解決方案實例
solution = ReinforcementLearningOptSolution()
