...
class ThompsonSamplingOptimization:
    """
    Thompson採樣優化解決方案類
...
def main():
    ...
    solver = ThompsonSamplingOptimization(random_state=42)
    print("\n使用示例:")
