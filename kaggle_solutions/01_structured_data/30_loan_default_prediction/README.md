...
```python
from kaggle_solutions.01_structured_data.30_loan_default_prediction.solution import LoanDefaultPredictionSolution

# 創建解決方案實例
solution = LoanDefaultPredictionSolution()
