...
```python
from kaggle_solutions.01_structured_data.38_online_shopping_intention.solution import OnlineShoppingIntentionSolution

# 創建解決方案實例
solution = OnlineShoppingIntentionSolution()
