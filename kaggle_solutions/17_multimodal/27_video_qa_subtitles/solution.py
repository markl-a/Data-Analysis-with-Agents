"""
Video QA with Subtitles
=======================

This solution implements various approaches for answering questions about videos using visual content and subtitles.
...
@dataclass
class Config:
    """Configuration for Video QA with Subtitles"""
    feature_dim: int = 512
    hidden_dim: int = 256
...
class Model1:
    """First approach: Question encoding"""
...
class Model2:
    """Second approach: Video-text alignment"""
...
class Model3:
    """Third approach: Temporal reasoning"""
