...
```python
from kaggle_solutions.07_special_domains.55_environmental_monitoring.solution import EnvironmentalMonitoringSolution

# 創建解決方案實例
solution = EnvironmentalMonitoringSolution()
