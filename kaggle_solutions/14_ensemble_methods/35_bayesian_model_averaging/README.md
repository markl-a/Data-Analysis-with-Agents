...
Bayesian approach to model averaging with posterior probabilities.

Key Techniques:
- Bayesian model averaging
- Posterior probability weighting
- Model uncertainty
...
# 或從專案根目錄運行
python kaggle_solutions/14_ensemble_methods/35_bayesian_model_averaging/solution.py
```
