...
Ensemble of isolation forests for anomaly detection.
...
# 或從專案根目錄運行
python kaggle_solutions/14_ensemble_methods/32_isolation_forest_ensemble/solution.py
```
