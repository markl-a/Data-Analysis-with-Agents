...
Rotation forest ensemble with feature extraction.

Key Techniques:
- PCA-based rotation
- Feature subset selection
- Bootstrap sampling
- Diversity through transformation
...
# 或從專案根目錄運行
python kaggle_solutions/14_ensemble_methods/31_rotation_forests/solution.py
```
