...
class AdaboostVariants:
    """
    AdaBoost變體解決方案類
    
    實現AdaBoost系列的完整機器學習流程。
...
def main():
    ...
    solver = AdaboostVariants(random_state=42)
    print("\n使用示例:")
