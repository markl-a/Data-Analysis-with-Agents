...
Select ensemble members dynamically based on local competence.

Key Techniques:
- Local competence estimation
- K-nearest oracle
- Dynamic weighting
...
# 或從專案根目錄運行
python kaggle_solutions/14_ensemble_methods/34_dynamic_ensemble_selection/solution.py
```
