...
Ensemble training with negative correlation penalty.

Key Techniques:
- Diversity encouragement
- Correlation penalties
- Individual network training
...
```
29_negative_correlation_learning/
...
# 或從專案根目錄運行
python kaggle_solutions/14_ensemble_methods/29_negative_correlation_learning/solution.py
```
