...
Demonstrates CatBoost's ordered target encoding and categorical feature handling.

Key Techniques:
- Ordered target encoding
- Automatic categorical feature handling
- Symmetric trees
- Prediction time optimization
...
# 或從專案根目錄運行
python kaggle_solutions/14_ensemble_methods/17_catboost_categorical/solution.py
```
