...
class FeatureTransformation:
    ...
    def __init__(self, random_state: int = 42):
        ...
        print(f"✓ 特徵變換解決方案已初始化")
        print(f"  描述: Box-Cox變換")
...
def main():
    """
    主函數 - 演示如何使用FeatureTransformation
    """
    print(f"""
    ╔══════════════════════════════════════════════════════╗
    ║                                                      ║
    ...
    # 創建解決方案實例
    solver = FeatureTransformation(random_state=42)
    
    # 示例用法
    print("\n使用示例:")
    print("1. 基本用法:")
    print(f"   solver = FeatureTransformation()")
