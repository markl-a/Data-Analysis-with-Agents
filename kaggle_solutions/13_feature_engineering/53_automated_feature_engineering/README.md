...
```python
from solution import 自動特徵工程Solution

# 創建解決方案實例
solution = 自動特徵工程Solution()
...
**類別**: 特徵工程
**難度**: ⭐⭐⭐
**標籤**: `13_feature_engineering` `machine-learning` `data-science`
