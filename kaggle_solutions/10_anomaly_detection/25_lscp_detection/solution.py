...
def main():
    ...
    print("=" * 80)
    print("LSCP (Locally Selective Combination) Detection")
    print("=" * 80)
    ...
    plt.savefig('25_lscp_detection_roc_pr_curves.png', dpi=300, bbox_inches='tight')
    plt.close()
    
    # Score distributions
    fig = plot_score_distributions(y_test, scores_dict)
    plt.savefig('25_lscp_detection_score_distributions.png', dpi=300, bbox_inches='tight')
    plt.close()
    
    # 2D visualization
    fig = plot_2d_visualization(X_test, y_test, y_pred_dict, "LSCP (Locally Selective Combination) Detection")
    plt.savefig('25_lscp_detection_2d_visualization.png', dpi=300, bbox_inches='tight')
    plt.close()
    ...
    results_df.to_csv('25_lscp_detection_results.csv', index=False)
    print("\nResults saved!")
    print("\n" + "="*80)
