...
def main():
    ...
    print("=" * 80)
    print("Ensemble Methods for Anomaly Detection")
    print("=" * 80)
    ...
    plt.savefig('24_anomaly_ensemble_detection_roc_pr_curves.png', dpi=300, bbox_inches='tight')
    plt.close()
    
    # Score distributions
    fig = plot_score_distributions(y_test, scores_dict)
    plt.savefig('24_anomaly_ensemble_detection_score_distributions.png', dpi=300, bbox_inches='tight')
    plt.close()
    
    # 2D visualization
    fig = plot_2d_visualization(X_test, y_test, y_pred_dict, "Ensemble Methods for Anomaly Detection")
    plt.savefig('24_anomaly_ensemble_detection_2d_visualization.png', dpi=300, bbox_inches='tight')
    plt.close()
    ...
    results_df.to_csv('24_anomaly_ensemble_detection_results.csv', index=False)
    print("\nResults saved!")
    print("\n" + "="*80)
