...
def main():
    ...
    print("=" * 80)
    print("Distance-Based Outlier Detection")
    print("=" * 80)
    ...
    plt.savefig('17_distance_based_outlier_roc_pr_curves.png', dpi=300, bbox_inches='tight')
    plt.close()
    
    # Score distributions
    fig = plot_score_distributions(y_test, scores_dict)
    plt.savefig('17_distance_based_outlier_score_distributions.png', dpi=300, bbox_inches='tight')
    plt.close()
    
    # 2D visualization
    fig = plot_2d_visualization(X_test, y_test, y_pred_dict, "Distance-Based Outlier Detection")
    plt.savefig('17_distance_based_outlier_2d_visualization.png', dpi=300, bbox_inches='tight')
    plt.close()
    ...
    results_df.to_csv('17_distance_based_outlier_results.csv', index=False)
    print("\nResults saved!")
    print("\n" + "="*80)
