...
def main():
    ...
    print("=" * 80)
    print("Feature Bagging for Anomaly Detection")
    print("=" * 80)
    ...
    plt.savefig('23_feature_bagging_anomaly_roc_pr_curves.png', dpi=300, bbox_inches='tight')
    plt.close()
    
    # Score distributions
    fig = plot_score_distributions(y_test, scores_dict)
    plt.savefig('23_feature_bagging_anomaly_score_distributions.png', dpi=300, bbox_inches='tight')
    plt.close()
    
    # 2D visualization
    fig = plot_2d_visualization(X_test, y_test, y_pred_dict, "Feature Bagging for Anomaly Detection")
    plt.savefig('23_feature_bagging_anomaly_2d_visualization.png', dpi=300, bbox_inches='tight')
    plt.close()
    ...
    results_df.to_csv('23_feature_bagging_anomaly_results.csv', index=False)
    print("\nResults saved!")
    print("\n" + "="*80)
