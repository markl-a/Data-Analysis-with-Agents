...
```python
from kaggle_solutions.10_anomaly_detection.42_fraud_detection_realtime.solution import FraudDetectionRealtimeSolution

# 創建解決方案實例
solution = FraudDetectionRealtimeSolution()
