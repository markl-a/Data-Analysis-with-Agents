...
```python
from solution import Transformer異常Solution

# 創建解決方案實例
solution = Transformer異常Solution()
...
**類別**: 異常檢測
**難度**: ⭐⭐⭐
**標籤**: `10_anomaly_detection` `machine-learning` `data-science`
