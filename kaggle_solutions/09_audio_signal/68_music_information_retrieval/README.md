...
```python
from solution import 音樂信息檢索Solution

# 創建解決方案實例
solution = 音樂信息檢索Solution()
...
**類別**: 音訊信號
**難度**: ⭐⭐⭐⭐
**標籤**: `09_audio_signal` `machine-learning` `data-science` `advanced`
