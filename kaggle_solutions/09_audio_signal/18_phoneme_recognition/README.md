...
This solution demonstrates phoneme segmentation and classification for speech analysis.

Dataset: Synthetic audio signals
Techniques:
- Phoneme segmentation using energy/ZCR
...
# 或從專案根目錄運行
python kaggle_solutions/09_audio_signal/18_phoneme_recognition/solution.py
```
