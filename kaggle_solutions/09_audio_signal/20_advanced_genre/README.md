...
This solution demonstrates multi-feature music genre classification system.

Dataset: Synthetic audio signals
Techniques:
- Comprehensive feature extraction
- Spectral, rhythmic, and timbral features
...
# 或從專案根目錄運行
python kaggle_solutions/09_audio_signal/20_advanced_genre/solution.py
```
