...
class DeepfakeAudioDetection:
    """
    深度偽造音頻檢測解決方案類
    
    實現Deepfake檢測的完整機器學習流程。
...
def main():
    ...
    solver = DeepfakeAudioDetection(random_state=42)
    print("\n使用示例:")
