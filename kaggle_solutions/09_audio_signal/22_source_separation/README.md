...
This solution demonstrates separation of music into vocals, drums, bass, and other.
...
- SDR/SIR/SAR metrics
- Separated source visualization
...
# 或從專案根目錄運行
python kaggle_solutions/09_audio_signal/22_source_separation/solution.py
```
