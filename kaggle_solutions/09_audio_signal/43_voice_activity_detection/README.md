...
```python
from kaggle_solutions.09_audio_signal.43_voice_activity_detection.solution import VoiceActivityDetectionSolution

# 創建解決方案實例
solution = VoiceActivityDetectionSolution()
