...
This solution demonstrates perceptual audio coding techniques.
...
# 或從專案根目錄運行
python kaggle_solutions/09_audio_signal/25_audio_compression/solution.py
```
