...
This solution demonstrates detection and classification of acoustic events.
...
# 或從專案根目錄運行
python kaggle_solutions/09_audio_signal/28_sound_event_detection/solution.py
```
