...
```python
from solution import GraphSAGE歸納Solution

# 創建解決方案實例
solution = GraphSAGE歸納Solution()
...
**類別**: 圖神經網絡
**難度**: ⭐⭐⭐
**標籤**: `11_graph_networks` `machine-learning` `data-science`
