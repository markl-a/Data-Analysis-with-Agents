...
def main():
    ...
    ║          圖Transformer                    ║
    ║          Kaggle Solution                            ║
    ║  描述: Graph Transformer               ║
    ╚══════════════════════════════════════════════════════╝
    """)
    
    solver = GraphTransformer(random_state=42)
    print("\n使用示例:")
