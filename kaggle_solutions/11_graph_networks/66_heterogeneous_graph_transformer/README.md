...
本解決方案提供了異構圖Transformer的完整實現，包括：
...
```python
from solution import 異構圖TransformerSolution

# 創建解決方案實例
solution = 異構圖TransformerSolution()
...
**類別**: 圖神經網絡
**難度**: ⭐⭐⭐⭐
**標籤**: `11_graph_networks` `machine-learning` `data-science` `advanced`
