...
Batch Normalization Alternatives - Deep Learning Solution
...
```
22_batch_normalization_alternatives/
...
# 或從專案根目錄運行
python kaggle_solutions/08_deep_learning/22_batch_normalization_alternatives/solution.py
```
