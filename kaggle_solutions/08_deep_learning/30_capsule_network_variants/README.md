...
Capsule Network Variants - Deep Learning Solution
...
# 或從專案根目錄運行
python kaggle_solutions/08_deep_learning/30_capsule_network_variants/solution.py
```
