...
Transfer Learning Strategies - Deep Learning Solution
...
```
25_transfer_learning_strategies/
...
# 或從專案根目錄運行
python kaggle_solutions/08_deep_learning/25_transfer_learning_strategies/solution.py
```
