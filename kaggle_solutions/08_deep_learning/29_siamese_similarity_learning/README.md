...
Siamese Similarity Learning - Deep Learning Solution
...
```
29_siamese_similarity_learning/
...
# 或從專案根目錄運行
python kaggle_solutions/08_deep_learning/29_siamese_similarity_learning/solution.py
```
