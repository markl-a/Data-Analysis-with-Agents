...
Advanced NAS - Deep Learning Solution
...
```
31_neural_architecture_search_advanced/
...
# 或從專案根目錄運行
python kaggle_solutions/08_deep_learning/31_neural_architecture_search_advanced/solution.py
```
