...
class InformerForecasting:
    """
    Informer預測解決方案類
    
    實現高效Transformer的完整機器學習流程。
...
def main():
    ...
    solver = InformerForecasting(random_state=42)
    print("\n使用示例:")
