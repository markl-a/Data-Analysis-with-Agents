...
Solve TSP for optimal route planning using various algorithms
...
class TravelingSalesmanAnalyzer:
    """Main analysis class"""
    ...
    def visualize_results(self):
        ...
        plt.tight_layout()
        filename = '21_traveling_salesman.png'
...
def main():
    ...
    print("="*60)
    print("TRAVELING SALESMAN PROBLEM - ROUTE OPTIMIZATION")
    print("="*60)

    # Initialize analyzer
    analyzer = TravelingSalesmanAnalyzer()
