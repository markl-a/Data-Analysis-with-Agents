...
Calculate visibility and viewshed from observer points
...
class ViewshedAnalysisAnalyzer:
    """Main analysis class"""
    ...
    def visualize_results(self):
        ...
        plt.tight_layout()
        filename = '26_viewshed_analysis.png'
...
def main():
    ...
    print("="*60)
    print("VIEWSHED AND LINE-OF-SIGHT ANALYSIS")
    print("="*60)

    # Initialize analyzer
    analyzer = ViewshedAnalysisAnalyzer()
