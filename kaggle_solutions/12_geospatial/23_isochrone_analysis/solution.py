...
Calculate reachability areas and service coverage zones
...
class IsochroneAnalysisAnalyzer:
    """Main analysis class"""
    ...
    def visualize_results(self):
        ...
        plt.tight_layout()
        filename = '23_isochrone_analysis.png'
...
def main():
    ...
    print("="*60)
    print("ISOCHRONE AND SERVICE AREA ANALYSIS")
    print("="*60)

    # Initialize analyzer
    analyzer = IsochroneAnalysisAnalyzer()
