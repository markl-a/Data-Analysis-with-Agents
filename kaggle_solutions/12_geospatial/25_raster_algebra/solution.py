"""
Raster Algebra and Map Overlay Operations
Perform raster calculations and overlay analysis
...
class RasterAlgebraAnalyzer:
    ...
    def visualize_results(self):
        ...
        plt.tight_layout()
        filename = '25_raster_algebra.png'
...
def main():
    ...
    print("="*60)
    print("RASTER ALGEBRA AND MAP OVERLAY OPERATIONS")
    print("="*60)

    # Initialize analyzer
    analyzer = RasterAlgebraAnalyzer()
